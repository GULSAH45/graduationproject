    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await fetch(
          "https://fe1111.projects.academy.onlyjs.com/api/v1/products?offset=0&main_category=38fb5754-3068-4490-a12a-169fa564c675&sub_category=04c9618e-553a-43cd-a72e-b646215d23e5"
        );
        ...
        //dönen şey bi array mi kontrol et
  ...
  return (
    <SafeAreaView >
      ...
      <View className="flex-row items-center mx-2 mt-4 my-4">
        ...
        <Text className="text-black text-md font-semibold ml-2">Protein</Text>
      </View>
              ...
              >
                {item.photo_src && (
                  <Image
                    ...
                    style={{ width: "100%", height: 100, marginVertical: 8,  borderRadius:10}}
                    resizeMode="contain"
                  />
                )}
