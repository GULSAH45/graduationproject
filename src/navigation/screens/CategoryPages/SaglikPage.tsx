    ...
    const fetchProducts = async () => {
      try {
        const response = await fetch(
          'https://fe1111.projects.academy.onlyjs.com/api/v1/products?limit=20&offset=0&main_category=cae64711-98b9-48f4-82b4-c5d460718dcf'
        )
  ...
  return (
    <SafeAreaView>
      ...
      <View className="items-center">
        <Text className="text-black text-2xl font-semibold">Sağlık Ürünleri</Text>
      </View>
